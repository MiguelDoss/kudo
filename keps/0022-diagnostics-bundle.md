...
- **File**: Copy a file out of a running pod. This is useful for non-stdout
...
- **Command**: Run a command on a running pod and copy the stdout. Higher level
  ...
  that resource.
- **Job**: Run a job and copy the stdout and other arbitrary files.
...
- **Scrub**: Scrubs all collected resources, including default resources, of a
  particular value. This can be a string, regular expression, or
